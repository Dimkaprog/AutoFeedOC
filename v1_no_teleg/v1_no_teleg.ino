...
#define BOT_TOKEN "8005128047:AAGArCsTFc3sWa-ptlTLFc4EUATswmv9aFY"
#define CHAT_ID "1180348190" // вести свои данные от бота
const char* ssid = "alkb2"; //Название сети!!!
const char* password = "!qazse$567890"; //Пароль!!!
